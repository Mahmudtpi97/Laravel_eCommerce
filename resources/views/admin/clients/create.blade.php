                ...
                <form class="form-horizontal" action="{{route('clients.store')}}" method="POST"  enctype="multipart/form-data">
                    ...
                    <fieldset>
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="file" class="span6 typeahead" id="client_img"  name="client_img" value="{{old('client_img')}}">
                                {{-- <textarea type="file" id="my-editor" name="slider_img" class="form-control">{!! old('content', 'test editor content') !!} </textarea> --}}
                            </div>
                        </div>

                        <div class="control-group">
                            <label class="control-label" for="status">Client Status</label>
                            <div class="controls cat_checkbox">
                                <input type="checkbox"  id="status"  name="status" value="0">
                                <p class="help-block">Click the checkbox and active the Client </p>
                            </div>
                        </div>
